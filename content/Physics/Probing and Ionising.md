...
Electron scattering experiments involve firing electrons at high relativistic speeds. Special relativity is covered in detail in [[Our Place in the Universe#Special relativity|Our Place in the Universe]].

#### Quarks
Protons and neutrons are composed of smaller elementary particles, **quarks**. A proton is formed by three up, up, and down quarks bound together by the strong force, while a neutron is formed by three down, down, and up quarks. The up quark has a charge of $\frac{2}{3}e$, while the down quark has a charge of $-\frac{1}{3}e$. **Hadrons** are composite particles formed by quarks.
#### Exchange particles
