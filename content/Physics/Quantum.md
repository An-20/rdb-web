## Quanta
Light can be modelled as **photons** - discrete **quanta** of light that carry fixed quantities of energy. The energy of a photon with frequency $f$ is given by:
$$E = hf = \frac{hc}{\lambda}$$
Where $h$ is the Planck constant ($6.63\times10^{-34}\,\,\text{J s}$).
...
For example, red light has a wavelength of $\sim700$ nm. By $E=hf=\frac{hc}{\lambda}$, this corresponds to an energy of around $2.84\times 10^{-19}\,\text{J} = 1.77\,\text{eV}$. Red LEDs do indeed require around 1.8V to turn on. This principle can be used in a practical to find Planck's constant:
...
#### Line spectra
As described in [[Probing and Ionising#Evidence for discrete energy levels|Probing and Ionising]], atoms emit or absorb electromagnetic radiation of specific wavelengths, corresponding to electrons falling or gaining energy levels. 
