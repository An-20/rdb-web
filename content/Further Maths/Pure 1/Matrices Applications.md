...
A system of **linear simultaneous equations** can be written as a matrix multiplication equation. For example:
$$
\begin{split}
3x + 4y - z = 5
\\ 2x + y - 2z = -12
...
### 2D transformations
#### Rotations
For a rotation angle $\theta$ anticlockwise, the rotation matrix is given by:
